...
pub struct McpStatus {
    ...
    pub recipe: McpRecipe,
    pub source: String,
    pub state: HashMap<TargetName, String>,
    pub deployed: HashMap<TargetName, McpRecipe>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub catalog: Option<McpRecipe>,
    #[serde(skip_serializing_if = "Option::is_none")]
